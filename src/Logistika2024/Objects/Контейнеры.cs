    ...
    public class Контейнеры : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтейнерыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтейнерыE", typeof(IIS.Logistika2024.Контейнеры));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтейнерыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтейнерыL", typeof(IIS.Logistika2024.Контейнеры));
                }
            }
        }
    }
