...
namespace IIS.Logistika2024
{
    ...
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika2024.Организация fОрганизация;
        
        private IIS.Logistika2024.Клиенты fКлиенты;
        
        private IIS.Logistika2024.DetailArrayOfТЧИнфОЗак fТЧИнфОЗак;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Logistika2024.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Logistika2024.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Logistika2024.Организация Организация
        {
            get
            {
                ...
                IIS.Logistika2024.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Logistika2024.DetailArrayOfТЧИнфОЗак ТЧИнфОЗак
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗак = new IIS.Logistika2024.DetailArrayOfТЧИнфОЗак(this);
                }
                IIS.Logistika2024.DetailArrayOfТЧИнфОЗак result = this.fТЧИнфОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставE", typeof(IIS.Logistika2024.ДокумПостав));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставL", typeof(IIS.Logistika2024.ДокумПостав));
                }
            }
        }
    }
