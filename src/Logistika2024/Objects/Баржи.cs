...
namespace IIS.Logistika2024
{
    ...
    public class Баржи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika2024.DetailArrayOfТЧРасписание fТЧРасписание;
        ...
        public virtual IIS.Logistika2024.DetailArrayOfТЧРасписание ТЧРасписание
        {
            get
            {
                ...
                {
                    this.fТЧРасписание = new IIS.Logistika2024.DetailArrayOfТЧРасписание(this);
                }
                IIS.Logistika2024.DetailArrayOfТЧРасписание result = this.fТЧРасписание;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БаржиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиE", typeof(IIS.Logistika2024.Баржи));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БаржиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиL", typeof(IIS.Logistika2024.Баржи));
                }
            }
        }
    }
