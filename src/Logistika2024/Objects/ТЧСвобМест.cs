...
namespace IIS.Logistika2024
{
    ...
    public class ТЧСвобМест : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika2024.ДокумРезультП fДокумРезультП;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika2024.ДокумРезультП.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ДокумРезультП"})]
        public virtual IIS.Logistika2024.ДокумРезультП ДокумРезультП
        {
            get
            {
                ...
                IIS.Logistika2024.ДокумРезультП result = this.fДокумРезультП;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧСвобМестE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧСвобМестE", typeof(IIS.Logistika2024.ТЧСвобМест));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧСвобМест : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika2024.DetailArrayOfТЧСвобМест members)

        // *** End programmer edit section *** (IIS.Logistika2024.DetailArrayOfТЧСвобМест members)
        ...
        /// </summary>
        public DetailArrayOfТЧСвобМест(IIS.Logistika2024.ДокумРезультП fДокумРезультП) : 
                base(typeof(ТЧСвобМест), ((ICSSoft.STORMNET.DataObject)(fДокумРезультП)))
        {
        }
        
        public IIS.Logistika2024.ТЧСвобМест this[int index]
        {
            get
            {
                return ((IIS.Logistika2024.ТЧСвобМест)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika2024.ТЧСвобМест dataobject)
        {
