...
namespace IIS.Logistika2024
{
    ...
    public class ТЧИнфОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika2024.ДокумПостав.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОЗакE", typeof(IIS.Logistika2024.ТЧИнфОЗак));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОЗак : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika2024.DetailArrayOfТЧИнфОЗак members)

        // *** End programmer edit section *** (IIS.Logistika2024.DetailArrayOfТЧИнфОЗак members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОЗак(IIS.Logistika2024.ДокумПостав fДокумПостав) : 
                base(typeof(ТЧИнфОЗак), ((ICSSoft.STORMNET.DataObject)(fДокумПостав)))
        {
        }
        
        public IIS.Logistika2024.ТЧИнфОЗак this[int index]
        {
            get
            {
                return ((IIS.Logistika2024.ТЧИнфОЗак)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika2024.ТЧИнфОЗак dataobject)
        {
